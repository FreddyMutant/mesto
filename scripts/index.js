...
const formNameElement = formElement.querySelector('.popup__input_type_name');
const formDescriptionElement = formElement.querySelector('.popup__input_type_description');
